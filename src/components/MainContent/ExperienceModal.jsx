...
const ExperienceModal = (props) => {
  const { show, handleClose, experienceToEdit } = props;
  ...
  return (
    <Modal size="lg" aria-labelledby="contained-modal-title-vcenter" show={show} onHide={handleClose} centered>
      <Modal.Header closeButton>
        <Modal.Title id="contained-modal-title-vcenter">{experienceToEdit ? "Modifca esperienza" : "Aggiungi esperienza"}</Modal.Title>
      </Modal.Header>
      <Form>
        ...
        <Modal.Body>
          ...
          <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
            ...
            <Form.Control size="sm" type="text" placeholder="Esempio: Retail Sales Manager" required name="role" value={formData.role} />
          </Form.Group>
          ...
          <Form.Group className="mb-4" controlId="exampleForm.ControlInput1">
            ...
            <Form.Control size="sm" type="text" placeholder="Esempio: Microsoft" name="company" value={formData.company} required />
          </Form.Group>
          <Form.Check type="checkbox" id="default-checkbox" label="Attualmente ricopro questo ruolo" className="mb-3" />

          <Form.Label>Data di inizio*</Form.Label>
          <InputGroup className="mb-3">
            <Form.Select aria-label="Default select example" size="sm" className="me-1" required name="startMonth" value={formData.startMonth}>
              <option>Mese</option>
            ...
            <Form.Select aria-label="Default select example" size="sm" className="ms-1" required name="startYear" value={formData.startYear}>
              <option>Anno</option>
          ...
          <InputGroup className="mb-3">
            <Form.Select aria-label="Default select example" size="sm" className="me-1" required name="endMonth" value={formData.endMonth}>
              <option>Mese</option>
              <option value="Gennaio">Gennaio</option>
              <option value="Febbraio">Febbraio</option>
              <option value="Marzo">Marzo</option>
            ...
            <Form.Select aria-label="Default select example" size="sm" className="ms-1" required name="endYear" value={formData.endYear}>
              <option>Anno</option>
              <option value="2025">2025</option>
              <option value="2024">2024</option>
              <option value="2023">2023</option>
          ...
          <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
            ...
            <Form.Control size="sm" type="text" placeholder="Esempio: Milano, Italia" required name="area" value={formData.area} />
          </Form.Group>
        ...
        <Modal.Footer>
          <Button variant="primary rounded-pill">Salva</Button>
        </Modal.Footer>
      </Form>
    </Modal>
  );
