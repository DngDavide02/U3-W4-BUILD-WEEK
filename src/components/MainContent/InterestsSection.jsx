...
const InterestSection = () => {
  ...
  const [activeKey, setActiveKey] = useState("Aziende");

  // --- Dati statici per le varie categorie ---
  const aziende = [
    {
      id: 1,
      name: "IBM",
  ...
  // --- Funzione per generare il link nel footer a seconda della tab attiva ---
  const getFooterLink = () => {
    switch (activeKey) {
      case "Aziende":
      ...
      case "Gruppi":
        return null; // Nessun footer per Gruppi
      default:
        return null;
    }
  };
  ...
  // --- Componente riutilizzabile per ogni elemento d'interesse ---
        ...
        <Col>
          <Card className="mb-2 px-2">
            <Card.Body className="pb-0">
              ...
              {/* Tabs per selezionare la categoria */}
            ...
            {/* Footer con link dinamico, visibile solo se presente */}
            {footerLink && (
